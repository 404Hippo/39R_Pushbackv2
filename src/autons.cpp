...
void soloAWP() {
    ...
    chassis.moveToPoint(39, -49, 2000, {.forwards = false, .minSpeed = 60, .earlyExitRange = 1});
    chassis.turnToHeading(-180, 600);
    matchloader.extend();
    chassis.waitUntilDone();
    chassis.setPose(leftValue, chassis.getPose().y, chassis.getPose().theta);
    chassis.moveToPoint(48, -60.25 , 1000, {.maxSpeed = 60});
    chassis.waitUntilDone();
    ...
    pros::delay(700);
    Score = false;
    chassis.moveToPoint(40, -35, 500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.turnToHeading(-60, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.moveToPoint(24, -26, 1500, {.minSpeed = 60, .earlyExitRange = 8});
    chassis.turnToHeading(-90, 500, {.minSpeed = 60, .earlyExitRange = 8});
    chassis.moveToPoint(-15, -26.5, 1500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.waitUntil(30);
    matchloader.extend();
    chassis.turnToHeading(-130, 500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.moveToPoint(-44, -45, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.turnToHeading(-180, 750, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.moveToPoint(-44, -30, 700, {.forwards = false, .maxSpeed = 70});
    chassis.waitUntilDone();
    chassis.setPose(-49, -31.25, chassis.getPose().theta);
    Score = true;
    pros::delay(1000);
    ...
    chassis.moveToPoint(-14, -16, 1500, {.forwards = false});
...
void soloAWPSplit() {
    ...
    chassis.moveToPoint(-24, -22, 1500, {.minSpeed = 60, .earlyExitRange = 8});
    chassis.turnToHeading(80, 500, {.minSpeed = 60, .earlyExitRange = 8});
    chassis.moveToPoint(15, -24, 1500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.waitUntil(30);
    matchloader.extend();
    chassis.turnToHeading(-45, 500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.waitUntil(40);
    matchloader.retract();
    chassis.moveToPose(5, -15, -45, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.waitUntilDone();
    Intake = -12000;
    Score = true;
    intake.extend();
    ...
    chassis.turnToHeading(-135, 500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.moveToPose(-12, -10, -135, 1000, {.forwards = false});
    ...
    pros::delay(700);
    Score = false;
    chassis.moveToPoint(-37, -40, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.turnToHeading(-170, 500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.waitUntil(170);
    level.extend();
    isLevelUp = true;
    wing.retract();
    chassis.moveToPoint(-38.5, -15, 10000, {.forwards = false, .maxSpeed = 80});
    chassis.waitUntilDone();
    chassis.moveToPoint(-38.5, -15, 10000, {.forwards = true, .maxSpeed = 30});
    chassis.waitUntilDone();
...
void leftSplit() {
    ...
    wing.extend();
    Intake = 12000;
    chassis.moveToPoint(-38.5, -49, 2000, {.forwards = false, .minSpeed = 60, .earlyExitRange = 1});
    chassis.turnToHeading(180, 500);
    matchloader.extend();
    chassis.waitUntilDone();
    chassis.setPose(-rightValue, chassis.getPose().y, chassis.getPose().theta);
    chassis.moveToPoint(-48, -60, 900, {.maxSpeed = 60});
    chassis.waitUntilDone();
    chassis.moveToPoint(-49, -25, 900, {.forwards = false, .maxSpeed = 70});
    chassis.waitUntilDone();
    chassis.setPose(-49, -31.25, chassis.getPose().theta);
    ...
    pros::delay(700);
    Score = false;
    chassis.moveToPoint(-49, -35, 500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.turnToHeading(60, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.moveToPoint(-24, -22, 1500, {.minSpeed = 60, .earlyExitRange = 8});
    chassis.waitUntil(12);
    matchloader.extend();
    chassis.turnToHeading(-135, 800, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.moveToPose(-6, -10, -135, 1000, {.forwards = false});
    chassis.waitUntil(8);
    level.retract();
    isLevelUp = false;
    chassis.waitUntilDone();
    ...
    pros::delay(700);
    Score = false;
    chassis.moveToPoint(-35, -40, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.turnToHeading(-170, 500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.waitUntil(170);
    level.extend();
    isLevelUp = true;
    wing.retract();
    chassis.moveToPoint(-35.5, -15, 10000, {.forwards = false, .maxSpeed = 80});
    chassis.waitUntilDone();
    chassis.moveToPoint(-35.5, -12, 10000, {.forwards = false, .maxSpeed = 30});
    chassis.waitUntilDone();
    chassis.turnToHeading(-165, 10000);
    chassis.waitUntilDone();
}
...
void rightSplit() {
    ...
    wing.extend();
    Intake = 12000;
    chassis.moveToPoint(40, -49, 2000, {.forwards = false, .minSpeed = 60, .earlyExitRange = 1});
    chassis.turnToHeading(-180, 500);
    matchloader.extend();
    chassis.waitUntilDone();
    chassis.setPose(leftValue, chassis.getPose().y, chassis.getPose().theta);
    chassis.moveToPoint(48, -60, 1000, {.maxSpeed = 50});
    chassis.waitUntilDone();
    ...
    Score = false;
    chassis.moveToPoint(49, -35, 500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.turnToHeading(-45, 1500, {.minSpeed = 60, .earlyExitRange = 4});
    ...
    intake.retract();
    Score = false;
    chassis.moveToPoint(34, -40, 1500, {.forwards = false, .minSpeed = 60, .earlyExitRange = 4});
    chassis.turnToHeading(0, 500, {.minSpeed = 60, .earlyExitRange = 4});
    chassis.waitUntil(100);
    wing.retract();
    chassis.moveToPoint(35, -15, 10000, {.maxSpeed = 80});
    chassis.waitUntilDone();
    chassis.moveToPoint(35, -14, 10000, {.maxSpeed = 30});
    chassis.waitUntilDone();
...
void leftCounterSplit() {
    ...
    chassis.waitUntilDone();
    chassis.setPose(-rightValue, chassis.getPose().y, chassis.getPose().theta);
    chassis.moveToPoint(-48.5, -60.25, 900, {.maxSpeed = 60});
    chassis.waitUntilDone();
    chassis.moveToPoint(-47, -50, 1500, {.forwards = false, .minSpeed = 60, .earlyExitRange = 4});
    chassis.moveToPoint(-40, -40, 1500, {.forwards = false, .minSpeed = 60, .earlyExitRange = 4});
    chassis.waitUntil(1);
    ...
    chassis.waitUntilDone();
    chassis.moveToPoint(-38.5, -7, 1500, {.forwards = false, .maxSpeed = 30});
    chassis.waitUntilDone();
    pros::delay(2000);
    wing.retract();
    pros::delay(100);
    ...
    wing.extend();
    chassis.turnToHeading(180, 500, {.minSpeed = 60, .earlyExitRange = 1});
    chassis.moveToPoint(-49.5, -20, 800, {.forwards = false, .maxSpeed = 80});
    chassis.waitUntilDone();
    chassis.setPose(-49, -31.25, chassis.getPose().theta);
    Score = true;
    pros::delay(400);
